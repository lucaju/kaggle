...
const {sendLogEmail} = require('./emails/sendEmail');

const {collectDatasets} = require('./scraper/datasets');
const {collectUsers} = require('./scraper/users');
const {collectCompetitions} = require('./scraper/competitions');

const {addRanking} = require('./router/ranking');
